...
public class Theme_2 extends AppCompatActivity {

    TextToSpeech t1;
    Button btn1, msg,d2, d3, d4, d5, d6, d7, d8, d9, d0, dstar, dhash, one, bclear, call, contack, call_list, c;
...
//        });
        ...
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(Theme_2.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(Theme_2.this, new String[]{Manifest.permission.CALL_PHONE},REQUEST_PHONE_CALL);
            }
