...
public class theme_7 extends AppCompatActivity {

    TextToSpeech t1;
    Button btn1, d2,msg, d3, d4, d5, d6, d7, d8, d9, d0, dstar, dhash, one, bclear, call, contack, call_list, c;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_theme_7 );
